  ...
  context "bundle show" do
    ...
    context "with --outdated flag" do
      ...
      it "prints a deprecation warning informing about its removal", :bundler => "2" do
        expect(deprecations).to include("the `--outdated` flag to `bundle show` was undocumented and will be removed")
      end
    end
    ...
    context "with --verbose flag" do
      ...
      it "prints a deprecation warning informing about its removal", :bundler => "2" do
        expect(deprecations).to include("the `--verbose` flag to `bundle show` was undocumented and will be removed")
      end
    end
